export const perguntas = [
    {
        enunciado: "Ao me mudar para outro país, que diferenças culturais poderia encontrar e como elas afetariam minha vida diária?",
        alternativas: [
            {
                texto: "Barreira linguística",
                afirmacao: [
                    "A barreira linguística pode dificultar a comunicação eficaz entre pessoas de diferentes culturas.",
                    "Superar a barreira linguística é essencial para promover a compreensão e a colaboração global."
                ],
                proxima: 1,
            },
            {
                texto: "Adaptação a normas sociais distintas",
                afirmacao: [
                    "Adaptar-se a normas sociais distintas é crucial para evitar mal-entendidos e promover a harmonia em ambientes multiculturais.",
                    "A flexibilidade e a abertura para aprender sobre normas sociais diferentes enriquecem as interações e fortalecem as relações interpessoais."
                ],
                proxima: 2,
            },
        ]
